...
class RNNTEST2(Model):
	def __init__(self,sess,data_loader,word_embed_size,encoder_size,decoder_size,learning_rate,epochs,attention_judge_size,learning_rate_decay_factor,use_pre_trained_embedding,max_gradient_norm,is_test,dropout_rate,binary):
		self.sess = sess
